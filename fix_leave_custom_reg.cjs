...
const findCode = `                {/* Standard presets (3, 4, 7, 15, 21, 30 days) */}
...
const replaceCode = `                {/* Standard presets (3, 4, 7, 15, 21, 30 days) */}
...
console.log("Patched Custom Leave Design in LeaveRegisterView!");
