...
export const ParadeStateFormattedView: React.FC<ParadeStateFormattedViewProps> = ({
 ...
 <span className="truncate">
 <span className="font-bold text-slate-900 dark:text-white print:text-black ">{formatAirmanName(a.rank)}</span> {a.name} <span className="text-[11px] text-slate-400">({a.trade})</span>
 </span>
 </div>
...
<PrintableParadeStateModal
              ...
              userFlight={userFlight} initialHideEmptyColumns={hideEmptyColumns}
 initialFromDate={fromDate} initialToDate={toDate}
 shift="Morning"
 flight={selectedFlight}
 airmen={airmen}
