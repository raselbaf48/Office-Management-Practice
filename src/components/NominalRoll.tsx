...
export const NominalRoll: React.FC<NominalRollProps> = ({
  ...
  const ranksList: (Rank | 'All')[] = ['All', 'SWO', 'WO', 'Sgt', 'Cpl', 'LAC'];
                    ...
                    <div className="flex items-center justify-end space-x-1">
                      ...
                      {role === 'ADMIN' && (
                        <>
                          ...
                          <button
                            onClick={() => {
                              if (confirm(`Are you sure you want to remove ${airman.rank} ${airman.name} (${airman.bdNo}) from the nominal roll?`)) {
                                onDeleteAirman(airman.id);
                              }
                            }}
