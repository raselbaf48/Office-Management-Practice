...
export const IdacSettingsModal: React.FC<IdacSettingsModalProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'CONTACTS' | 'SHIFT_TIMES' | 'RESPONSIBILITIES'>('CONTACTS');
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-950/70 backdrop-blur-xs select-none overflow-y-auto">
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 w-full max-w-3xl rounded-3xl shadow-2xl overflow-hidden animate-scaleIn my-auto">
        ...
        {/* Tab switcher */}
        <div className="px-6 pt-3 border-b border-slate-200 dark:border-slate-800 flex items-center space-x-4 text-xs font-bold bg-slate-50/50 dark:bg-slate-800/30 overflow-x-auto">
          <button
            onClick={() => setActiveTab('CONTACTS')}
            className={`pb-3 px-1 border-b-2 transition-all cursor-pointer flex items-center space-x-1.5 whitespace-nowrap ${
              activeTab === 'CONTACTS'
          ...
          >
            ...
            <span>Shift Time Management</span>
          </button>
          <button
          ...
          >
            <span>Duty Responsibilities</span>
              ...
              <div className="p-3 bg-emerald-50/60 dark:bg-emerald-950/20 border border-emerald-200 dark:border-emerald-900/50 rounded-2xl flex items-center justify-between text-xs">
                <div className="space-y-0.5">
                  <div className="font-extrabold text-emerald-950 dark:text-emerald-200 flex items-center space-x-1.5">
                    <span>Seniority-Ordered Personnel Selection</span>
                  </div>
                  <p className="text-[11px] text-emerald-800/80 dark:text-emerald-300/80">
                    Checked items appear in Emergency Contacts. Seniority ranking (SWO &gt; WO &gt; SGT &gt; CPL &gt; LAC &gt; AC) is automatically maintained.
                  </p>
                </div>
