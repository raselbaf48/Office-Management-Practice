...
if (fs.existsSync(file)) {
  ...
  content = content.replace(
    /<div className="text-\[10px\] font-bold text-slate-900 dark:text-white uppercase">\s*\{prepared.name \|\| 'NAME'\}, \{prepared.rank \|\| 'RANK'\}, \{prepared.designation \|\| 'Designation'\}, \{prepared.unit \|\| '155 UASU BAF'\}\s*<\/div>/g,
  ...
  content = content.replace(
    /<div className="text-\[10px\] font-bold text-slate-900 dark:text-white uppercase">\s*\{authorized.name \|\| 'NAME'\}, \{authorized.rank \|\| 'RANK'\}, \{authorized.designation \|\| 'Designation'\}, \{authorized.unit \|\| '155 UASU BAF'\}\s*<\/div>/g,
    `<div className="text-xs font-black uppercase text-slate-900 dark:text-white">
