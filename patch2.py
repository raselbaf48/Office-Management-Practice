...
# <div className="text-[11px] font-bold uppercase">{preparedBy.rank}</div> -> <div className="text-[11px] font-normal">{preparedBy.rank}</div>
# <div className="text-[10px] font-normal">{preparedBy.unit || '155 UASU BAF'}</div> -> <div className="text-[10px] uppercase font-bold">{preparedBy.unit || '155 UASU BAF'}</div>
